    ...
    <nav className="fixed bg-gray-200 dark:bg-black z-10 top-0 left-0 right-0">
      <div className="max-w-7xl flex justify-between items-center m-auto p-5">
        ...
        <ul className="hidden lg:flex font-medium items-center gap-5">
          ...
          <NavLink to="/f" className={({ isActive }) => isActive ? "text-[#8c00ff]" : "text-foreground"}>{t("nav.2")}</NavLink>
          <NavLink to="/d" className={({ isActive }) => isActive ? "text-[#8c00ff]" : "text-foreground"}>{t("nav.3")}</NavLink>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-40">
            ...
            <DropdownMenuItem asChild>
              <NavLink to="/f">{t("nav.2")}</NavLink>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <NavLink to="/d">{t("nav.3")}</NavLink>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
